            ...
            <div className='grid grid-rows-2 items-center md:w-[550px] w-screen md:pl-[0px] pl-[10px]'>
                ...
                <div className='grid grid-rows-4 items-center pb-[10px]'>
                    <div className='flex grid-cols-2 pb-[20px] items-center'>
                        ...
                        <h3 className='font-poppins font-medium text-[16px] text-[#323232] pl-[20px] text-opacity-[40%]'>Fastest Food Delivery</h3>
                    </div>
                    <div className='flex grid-cols-2 pb-[20px] items-center'>
                        <IoIosList size={20} className='text-[#323232] text-opacity-[60%]'/>
                        <h3 className='font-poppins font-medium text-[16px] text-[#323232] pl-[20px] text-opacity-[40%]'>Monthly Plans Available</h3>
                    </div>
                    <div className='flex grid-cols-2 pb-[20px] items-center'>
                        <IoIosPeople size={20} className='text-[#323232] text-opacity-[60%]'/>
                        <h3 className='font-poppins font-medium text-[16px] text-[#323232] pl-[20px] text-opacity-[40%]'>Hygiene & Healthy</h3>
                    </div>
                    <div className='flex grid-cols-2 pb-[20px] items-center'>
                        <IoMdDoneAll size={20} className='text-[#323232] text-opacity-[60%]'/>
                        <h3 className='font-poppins font-medium text-[16px] text-[#323232] pl-[20px] text-opacity-[40%]'>Well Preserved Tiffins</h3>
                    </div>
                </div>
            </div>
            <img src={image02} alt='/' className='h-[350px] bg-[#FFCE54] rounded-3xl'/>
        </div>
    </div>
  )
}

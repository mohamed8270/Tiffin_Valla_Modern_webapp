       ...
       <div class='md:h-[500px] h-[750px] w-screen bg-white grid md:grid-cols-2 grid-cols-1 items-center justify-items-center md:px-[20px] px-[10px]'>
          ...
          <div className='grid md:grid-rows-2 grid-rows-1 items-center'>
            ...
            <div className='grid grid-cols-3'>
                <div className='md:h-[180px] md:w-[180px] h-[170px] w-[115px] hover:bg-white bg-[#323232] bg-opacity-5 rounded-lg shadow-xl'>
                    <div className='p-[10px]'>
                        ...
                        <h1 className='font-poppins text-[26px] font-bold text-[#FFCE54] pt-[20px]'>₹70<span className='font-poppins font-medium md:text-[10px] text-[8px] text-[#323232] text-opacity-40'>/Month</span> </h1>
                    </div>
                ...
                <div className='md:h-[180px] md:w-[180px] h-[170px] w-[115px] hover:bg-white bg-[#323232] bg-opacity-5 rounded-lg shadow-xl'>
                    <div className='p-[10px]'>
                        ...
                        <h1 className='font-poppins text-[26px] font-bold text-[#FFCE54] pt-[20px]'>₹450<span className='font-poppins font-medium md:text-[10px] text-[8px] text-[#323232] text-opacity-40'>/Month</span> </h1>
                    </div>
                    <div className='md:pt-[8px] pt-[12px]'>
                        <button className='h-[40px] md:w-[180px] w-[115px] bg-[#FFCE54] text-[#323232] font-poppins font-semibold justify-center rounded-b-lg'>Start Plan</button>
                    </div>
                ...
                <div className='md:h-[180px] md:w-[180px] h-[170px] w-[115px] hover:bg-white bg-[#323232] bg-opacity-5 rounded-lg shadow-xl'>
                    <div className='p-[10px]'>
                        ...
                        <h1 className='font-poppins text-[26px] font-bold text-[#FFCE54] pt-[20px]'>₹1900<span className='font-poppins font-medium md:text-[10px] text-[8px] text-[#323232] text-opacity-40'>/Month</span> </h1>
                    </div>
                    <div className='md:pt-[8px] pt-[12px]'>
                        <button className='h-[40px] md:w-[180px] w-[115px] bg-[#FFCE54] text-[#323232] font-poppins font-semibold justify-center rounded-b-lg'>Start Plan</button>
                    </div>

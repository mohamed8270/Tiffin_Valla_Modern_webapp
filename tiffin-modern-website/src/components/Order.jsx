    ...
    <div className='pt-[60px]'>
       <div class='md:h-[500px] h-[750px] w-screen bg-white grid md:grid-cols-2 grid-cols-1 items-center justify-items-center md:px-[20px] px-[10px]'>
          ...
          <div className='grid md:grid-rows-2 grid-rows-1 items-center'>
            <h1 className='md:text-[32px] text-[16px] text-[#323232] font-poppins font-semibold pb-[30px] md:pb-[0px] md:w-[600px] w-[px]'>Get major advantages by selecting variuos plans in our app and Enjoy! the delicious Indian Foods without any delay</h1>
